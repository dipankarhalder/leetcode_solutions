/**
  * Link - https://leetcode.com/problems/two-sum/submissions/1111725758/
...
// Ans 1. Regular way O(n2) / O(n^2)
let twoSumOne = function (nums, target) {
...
// Ans 2. Optimize way with O(n) using a hashmap
